...
<head>
    ...
    <title>BaeKY's DevOps Lab</title>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">BaeKY's DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hello</h1>
        <p>This is BaeKYs DevOps AWS Lab</p>
        <p><a class="btn btn-primary btn-lg" role="button">Learn more &raquo;</a></p>
        <p><a class="btn btn-primary btn-lg" role="button">0.0.7 &raquo;</a></p>
    </div>
</div>
...
<div class="container">
    ...
    <footer>
        <p>&copy; BaeKY's devops lab 2020-2021</p>
    </footer>
</div> <!-- /container -->
